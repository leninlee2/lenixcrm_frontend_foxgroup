...
@Component({
    standalone: true,
    selector: 'app-pipeline-topsalesman',
    imports: [ChartModule],
    template: `<div class="card !mb-8">
        <div class="font-semibold text-xl mb-4">Rank Pipeline Top Salesman</div>
        <p-chart type="bar" [data]="chartData" [options]="chartOptions" class="h-80" />
    </div>`
})
export class PipelineTopSalesmanWidget {
    chartData: any;
    ...
    getPipelineSalesman(){
        this.dashboardService.GetPipelineSalesman().subscribe(
            response => {
