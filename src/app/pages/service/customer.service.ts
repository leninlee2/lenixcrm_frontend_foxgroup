...
export class CustomerService {
    ...
    private apiUrlGetAllCustomers = ApiUrl + '/customer/all';
    private apiUrlAddCustomer = ApiUrl + '/customer/add';
    private apiUrlUpdateCustomer = ApiUrl + '/customer/update';

    GetAllCustomers(): Observable<CustomerDTO[]> {
        return this.http.get<CustomerDTO[]>(this.apiUrlGetAllCustomers);
    }

    AddCustomers(customer:CustomerDTO): Observable<boolean> {
        return this.http.post<boolean>(this.apiUrlAddCustomer,customer);
    }

    UpdateCustomers(customer:CustomerDTO): Observable<boolean> {
        return this.http.post<boolean>(this.apiUrlUpdateCustomer,customer);
    }
